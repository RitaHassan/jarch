                            ...
                            <div class="col-sm-3">
                                <div class="form-group" id="">
                                    <input type="text" data-kt-docs-table-filter="search"
                                        class="form-control form-control-solid w-250px ps-15" placeholder="اسم النظام">
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="SYSTEM_NAME" name="SYSTEM_NAME"
                                class="form-control form-control-solid" placeholder="اسم النظام">
                        </div>
                        <div class="col-md-3">
                            <br>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label class="required form-label fw-bolder">رقم النظام</label>
                            <input type="text" id="SYSTEM_NUM_UPDATE" name="SYSTEM_NUM_UPDATE"
                                class="form-control form-control-solid" placeholder="رقم النظام">
                        </div>
                        <div class="col-md-6">
                            <label class="required form-label fw-bolder">اسم النظام</label>
                            <input type="text" id="SYSTEM_NAME_UPDATE" name="SYSTEM_NAME_UPDATE"
                                class="form-control form-control-solid" placeholder="اسم النظام">
                        </div>
                        <div class="col-md-3">
                            <br>
                ...
                jQuery.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.status >= 1) {
                            ...
                            $("#SYSTEM_NUM").val("");
                            $("#SYSTEM_NAME").val("");
                            toastr.error('اسم النظام موجود مسبقا');
                            dt.draw();
                        }
                        dt.draw();
                    }
                ...
                jQuery.ajax({
                    ...
                    success: function(data) {
                        ...
                        data.forEach((d, index) => {
                            $("#members_table").find('tbody').append("<tr><td>" + (index + 1) +
                                "</td><td>" + d.MEM_NAME + "</td><td><a val-id='" + d.ID_SR +
