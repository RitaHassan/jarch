                            ...
                            <div class="col-sm-3">
                                <div class="form-group" id="">
                                    <input type="text" data-kt-docs-table-filter="search"
                                        class="form-control form-control-solid w-250px ps-15" placeholder="اسم الفريق">
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xl-12 form-group mb-12">
                        <label class="required form-label fw-bolder">اسم الفريق</label>
                        <input type="hidden" id="team_id" name="" value=""
                            class="form-control form-control-solid" placeholder="الفريق">
                        <input type="text" id="NAME_UPDATE" name="NAME" value=""
                            class="form-control form-control-solid" placeholder="الفريق">
                    </div>
                    <div class="card-footer">
                    ...
                    success: function(data) {
                        ...
                        data.forEach((d, index) => {
                            $("#members_table").find('tbody').append("<tr><td>" + (index + 1) +
                                "</td><td>" + d.MEM_NAME + "</td><td><a val-id='" + d.MEM_ID +
                                "' val_name='" + d.MEM_NAME + "' val_team_id='" + team_id +
