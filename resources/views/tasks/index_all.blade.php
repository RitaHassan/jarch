...
@section('contents')
                ...
                <div class="modal-body">
                    <form class="row" method="POST">
                        ...
                        <div class="col-xl-6 form-group mb-6">
                            ...
                            <textarea id="CANCELED_REASON" name="CANCELED_REASON"
                                class="form-control form-control-solid mb-8 f-family tinymce-editor" rows="4" cols="4"></textarea>
                        </div>
                </div>
                <div class="modal-footer">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-xl-4 form-group mb-4">
                            ...
                            <input type="text" name="ACTUAL_START_DT_1" id="ACTUAL_START_DT_1"
                                class="date3 form-control">
                        </div>
                        <div class="col-xl-4 form-group mb-4">
                        ...
                        <div class="col-xl-4 form-group mb-4">
                            ...
                            <input type="text" id="COMPLETION_PERIOD" name="COMPLETION_PERIOD"
                                value="{{ old('COMPLETION_PERIOD', $tasks->COMPLETION_PERIOD) }}"
                                class="form-control form-control-solid" placeholder="مدة الانجاز">
                        </div>
                        <div class="col-xl-4 form-group mb-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select name="MEM_ID" id="MEM_ID"
                                        class="form-control form-control-solid w-250px ps-15"
                                        data-kt-docs-table-filter="search5">
                                        <option value="" selected>--اختر--</option>
                                        @foreach ($get_all_members as $member)
                                            <option value="{{ $member->ID }}" {{ $member->ID }}>{{ $member->MEM_NAME }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" data-kt-docs-table-filter="search" id="task_titel"
                                        class="form-control form-control-solid w-250px ps-15" placeholder="عنوان المهمة">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-prepend input-group">
                                            <span class="add-on input-group-addon" id="remove_PLANNED_START_DT"><i
                                                    class="fa fa-trash"></i></span>
                                            <input class="form-control form-control-solid" placeholder="تاريخ المخطط له"
                                                id="PLANNED_START_DT" />
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-prepend input-group">
                                            <span class="add-on input-group-addon" id="remove_ACTUAL_START_DT"><i
                                                    class="fa fa-trash"></i></span>
                                            <input class="form-control form-control-solid" placeholder="تاريخ  الانجاز"
                                                id="ACTUAL_START_DT_" />
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select name="COMPLETION_STATUS" id="COMPLETION_STATUS"
                                        class="form-control form-control-solid w-250px ps-15"
                                        data-kt-docs-table-filter="search4">
            ...
            <table class="table table-bordered table-hover table-striped dataTable" id="STATISTICS">
    ...
    <script>
        ...
        var KTDatatablesServerSide = function() {
                ...
                dt = $("#kt_datatable_example_1").DataTable({
                    ...
                    columns: [
...

                        {
                            ...
                            'bSort': true,
                            render: function(data) {
                                if (data.COMPLETION_STATUS == 0 && data.PLANNED_START_DT == null &&
                                    data.PLANNED_FINISH_DT == null) {
            ...
            $("#toggel_1_save").click(function() {
                if ($("#ACTUAL_START_DT_1").val() == "" || $("#ACTUAL_FINISH_DT").val() == "" || $(
                        "#COMPLETION_PERIOD").val() == "" || $("#DURATION_TYPE").val() == "") {
        ...
        $( window ).on( "load", function() {
           // alert();
            $.ajax({
                url: '/statistics/Table_Statistics',
                type: 'get',
                data: {
                ...
                success: function(data) {
                    ...
                    $("#STATISTICS").append(
                        '<tr>'+
                        '<th>'+
                            '<td>المهام</td><td></td><td></td><td></td><td></td><td></td>'+
                        '</th>'+
                    '</tr>'+
                        '<tr>' +
                        '<td>رقم الهوية</td>' +
