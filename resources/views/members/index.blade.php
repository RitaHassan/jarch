                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 form-group mb-6">
                        ...
                        <button type="button" id="btn_update"
                            class='btn btn-sm btn-icon btn-xl btn-xl btn-primary btn-add-member'>تعديل</button>
                    </div>
                </div>
            </div>
  ...
  "order" : [],
                ...
                columns: [
                    ...
                    { data: 'CREATED_AT_MEM',"searchable": false },
                     { data: 'DELETED_AT',"searchable": false ,render: function (data) {
                         if(data == null){
